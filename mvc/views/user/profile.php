...
<!--begin::Card header-->
	...
	<!--end::Card title-->
	<!--begin::Action-->
	<a href="<?php base_url('edit_profile') ?>" class="btn btn-primary align-self-center">Edit Profile</a>
	<!--end::Action-->
	</div>
	<!--begin::Card header-->
	<!--begin::Card body-->
	...
	<!--begin::Row-->
		...
		<div class="col-lg-8 d-flex align-items-center">
			<span class="fw-bold fs-6 text-gray-800 me-2"><?=$userdetails->phone?></span>
