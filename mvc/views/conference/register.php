<div class="row">
                            ...
                            <form class="form w-100" novalidate="novalidate" method="post"    >
                                ...
                                <div class="row mb-8">
                                    <!--begin::Name-->
                                   <div class="col-lg-8">
                                        <select id="regtype_tt" class="form-control"   name="regtypeID" data-placeholder="Select Type of Registration">
                               ...
                               <div class="row mb-8">
                                   <div class="col-lg-6">
                                       <input type="text" placeholder="Title of Abstract" name="abstract_title" autocomplete="off" class="form-control bg-transparent" />
                                   </div>
                                   <div class="col-lg-6">
                            ...
                            ?>
                                ...
                                <div class="fv-row mb-8">
                                    <!--begin::Phone-->
                                    <input type="text" placeholder="Mailing Address" name="mailing_address" autocomplete="off" class="form-control bg-transparent" />
                                    <!--end::Phone-->
                                </div>
                                <div class="fv-row mb-8">
                                    <!--begin::Phone-->
